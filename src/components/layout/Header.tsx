...
export default function Header() {
  ...
  return (
    <Navbar
      className=" z-10 justify-between w-full md:w-11/12 mx-auto h-24 md:h-16 md:pt-10   md:pb-10 bg-gray-700 lg:bg-[#2e2c2c] backdrop-blur-lg"
      classNames={{
        wrapper: "max-w-full",
      }}
    >
      ...
      <Link href="/" className="order-2  ml-[4.5%]">
        <img src={data.logoMobile} alt="logo" className="h-20 lg:hidden mx-auto" />
      </Link>
      ...
      />
      {/* Mobile Menu */}
      <NavbarMenu dir="rtl" className="bg-gray-800/95 mt-7 pt-9 space-y-5 ">
        ...
        <Dropdown placement="bottom-start" className="cursor-pointer">
          ...
          <DropdownMenu aria-label="Profile Actions" variant="light" className="bg-MainDark">
            <DropdownItem color="danger"></DropdownItem>
          </DropdownMenu>
        </Dropdown>
      </NavbarMenu>
      {/* Cart Item */}
